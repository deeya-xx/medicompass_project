...
public class MainActivity extends AppCompatActivity {
                ...
                supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(@NonNull GoogleMap googleMap) {
                        if (location != null) {
                            ...
                            loadHospitalMarkers(googleMap);

                        } else {
                            Toast.makeText(MainActivity.this, "Please Turn On Your Location App Permission", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    public void loadHospitalMarkers(GoogleMap googleMap) {
        DatabaseReference hospitalRef = FirebaseDatabase.getInstance().getReference("Hospitals");

        hospitalRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!snapshot.exists()) {
                    Toast.makeText(MainActivity.this, "No hospitals found!", Toast.LENGTH_SHORT).show();
                    return;
